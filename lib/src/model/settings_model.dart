...
class SettingsModel extends InheritedModel<SettingsDependents> {
  ...
  // Settings Model Dark Color Scheme
  ...
  // Settings Model Light Color Scheme
  ...
  bool updateShouldNotifyDependent(
    ...
    Set<SettingsDependents> dependencies,
  ) {
    if (darkSchemeDependent != oldWidget.darkSchemeDependent &&
        dependencies.contains(
          SettingsDependents.darkSchemeDependent,
        )) {
      return true;
    }
    if (lightSchemeDependent != oldWidget.lightSchemeDependent &&
        dependencies.contains(
          SettingsDependents.lightSchemeDependent,
        )) {
      return true;
    }
    return false;
